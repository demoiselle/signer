                        ...
                        try {
                                ...
                                switch (annotation.type()) {
                                        ...
                                        case CNPJ:
                                                ...
                                                } else if (cert.hasCertificateSE()) {
                                                        keyValue = cert.getICPBRCertificateSE().getCNPJ();
                                                } else {
                                        ...
                                        case CERTIFICATE_TYPE:
                                                keyValue = cert.getCertificateType();
                                                break;
                                ...
                                throw new CertificateCoreException(e.getMessage(), e);
                        }
                }
        }
}
