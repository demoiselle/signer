...
public class MSKeyStoreLoader implements KeyStoreLoader {
	...
	/**
	 * Workaround para bug 6672015 (aliases duplicados no SunMSCAPI).
	 * Resolvido na build 101 do Java 1.8 (bug 6483657). No-op para Java 8+.
	 */
	private void fixAliases(KeyStore keyStore) {
		// bug corrigido desde Java 1.8.0_101 — reflexão removida por incompatibilidade com Java 9+
	}
