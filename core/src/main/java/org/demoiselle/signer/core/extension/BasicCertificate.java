...
public class BasicCertificate {
        ...
        public static final String OID_AE_S_CERTIFICATE = "2.16.76.1.2.203";
        public static final String OID_AE_H_CERTIFICATE = "2.16.76.1.2.204";
        ...
        /**
         * Check if the certificate is a "ICP-BRASIL Selo Eletronico Certificate".
         * Resolução 211 ICP-Brasil<br>
         *
         * @return boolean true if certificate is a "ICP-BRASIL Selo Eletrônico"
         */
        public boolean hasCertificateSE() {
                if (getICPBRSubjectAlternativeNames() == null) {
                        return isSeloEletronico();
                }
                return getICPBRSubjectAlternativeNames().isCertificateSE() || isSeloEletronico();
        }

        /**
         * Returns data of "Selo Eletronico" on certificate in ICPBRCertificateSE
         * format<br>
         * If its not a "Selo Eletronico" certificate <br>
         * Returns <b>null</b>
         *
         * @return ICPBRCertificateSE Certificate Selo Eletrônico
         */
        public ICPBRCertificateSE getICPBRCertificateSE() {
                if (getICPBRSubjectAlternativeNames() == null) {
                        return null;
                }
                return getICPBRSubjectAlternativeNames().getICPBRCertificateSE();
        }
        ...
        public String getCertificateType() {
                String level = getCertificateLevel();
                if (level == null) return null;
                if (level.startsWith("SE-")) {
                        return "SE";
                }
        ...
        /**
         * Check if the certificate level indicates a Selo Eletronico (SE-S or SE-H).<br>
         *
         * @return boolean true if certificate level is SE-S or SE-H
         */
        public boolean isSeloEletronico() {
                String level = getCertificateLevel();
                return level != null && (level.equals("SE-S") || level.equals("SE-H"));
        }

        /**
         * Check if the certificate level indicates an Aplicacao Especifica (AE-S or AE-H).<br>
         *
         * @return boolean true if certificate level is AE-S or AE-H
         */
        public boolean isAplicacaoEspecifica() {
                String level = getCertificateLevel();
	...
	public String getNameAR() {
		try {
			...
			for (String part : parts) {
				...
				if (p.startsWith("OU=")) {
					String value = part.split("=")[1].trim();
					if (value.toUpperCase().contains("AUTORIDADE DE REGISTRO") || value.toUpperCase().startsWith("AR")) {
						return value;
					}
				}
			}
        ...
        public String toString() {
                ...
                try {
                        ...
                        sb.append("*********************************\n");
                        sb.append(coreMessagesBundle.getString("text.certicate.is.se")).append(this.hasCertificateSE()).append("\n");
                        if (this.hasCertificateSE()) {
                                ICPBRCertificateSE tdSE = this.getICPBRCertificateSE();
                                sb.append(coreMessagesBundle.getString("text.certicate.cnpj")).append(tdSE.getCNPJ()).append("\n");
                        }
