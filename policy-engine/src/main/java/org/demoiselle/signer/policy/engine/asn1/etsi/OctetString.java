...
public class OctetString extends ASN1Object {
	...
	protected ASN1OctetString derOctetString;
	...
	public ASN1OctetString getDerOctetString() {
		return derOctetString;
	}

	public void setDerOctetString(ASN1OctetString derOctetString) {
	...
	public void parse(ASN1Primitive derObject) {
		if (derObject instanceof ASN1OctetString) {
			this.derOctetString = (ASN1OctetString) derObject;
