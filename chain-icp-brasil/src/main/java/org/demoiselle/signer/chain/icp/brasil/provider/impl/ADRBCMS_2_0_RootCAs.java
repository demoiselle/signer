...
/**
 * Provides trusted Certificate Authority Root and policy OID for version 2.0 of the ICP-BRAZIL's
...
public class ADRBCMS_2_0_RootCAs implements ProviderSignaturePolicyRootCA {
    ...
    public Collection<X509Certificate> getCAs() {
        ...
        InputStream icpBrasilv2 = ADRBCMS_2_0_RootCAs.class.getClassLoader().getResourceAsStream("trustedca/ICP-Brasilv2.crt");
        try {
