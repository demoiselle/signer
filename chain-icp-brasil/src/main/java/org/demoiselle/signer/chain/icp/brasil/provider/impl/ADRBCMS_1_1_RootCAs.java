...
/**
 * 
 * Provides trusted Certificate Authority chain and policy OID for version 1.1 of the ICP-BRAZIL's
...
public class ADRBCMS_1_1_RootCAs implements ProviderSignaturePolicyRootCA {
    ...
    public Collection<X509Certificate> getCAs() {
        ...
        InputStream icpBrasil = ADRBCMS_1_1_RootCAs.class.getClassLoader().getResourceAsStream("trustedca/ICP-Brasil.crt");
        InputStream icpBrasilv2 = ADRBCMS_1_1_RootCAs.class.getClassLoader().getResourceAsStream("trustedca/ICP-Brasilv2.crt");
        try {
    ...
    /**
     * @deprecated  Repealed on 31/12/2014
     */
    @Deprecated
    @Override
