...
public enum XMLPoliciesOID {
	...
	AD_RB_XADES_2_5("2.16.76.1.7.1.6.2.5", "AD_RB_XADES_2_5"),
	...
	AD_RT_XADES_2_5("2.16.76.1.7.1.7.2.5", "AD_RT_XADES_2_5"),
	...
	public static String getPolicyNameByOID(String oid) {
		...
		case "2.16.76.1.7.1.6.2.5": {
			return AD_RB_XADES_2_5.getPolicyName();
		}
		...
		case "2.16.76.1.7.1.7.2.5": {
			return AD_RT_XADES_2_5.getPolicyName();
		}
		...
		case "2.16.76.1.7.1.8.2.5": {
			return AD_RV_XADES_2_5.getPolicyName();
		}
		...
		case "2.16.76.1.7.1.9.2.5": {
			return AD_RC_XADES_2_5.getPolicyName();
		}
		...
		case "2.16.76.1.7.1.10.2.5": {
			return AD_RA_XADES_2_5.getPolicyName();
		}
		default: {
			return AD_RB_XADES_2_5.getPolicyName();
		}
